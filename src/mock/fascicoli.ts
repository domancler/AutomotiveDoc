...
export const fascicoli: Fascicolo[] = [
  ...
  // --- CONSEGNA: inviato a VRC (Disponibili controllo consegna) ---
  {
    ...
    stato: "Consegna – in attesa di presa in carico",
    workflow: { overall: States.CONSEGNA_IN_ATTESA_PRESA_IN_CARICO, bo: States.VALIDATO_BO },
    ownerId: T.v1.id,
    assegnatario: T.v1.name,
    inChargeDelivery: T.del.id,
  ...
  // --- CONSEGNA: VRC in verifica (In corso VRC) ---
  {
    ...
    workflow: { overall: States.CONSEGNA_IN_VERIFICA, bo: States.VALIDATO_BO },
    ownerId: T.v2.id,
    assegnatario: T.v2.name,
    inChargeDelivery: T.del.id,
    deliverySentToVRC: true,
  ...
  // --- CONSEGNA: da controllare (torna all'operatore consegna, stesso owner) ---
  {
    ...
    workflow: { overall: States.CONSEGNA_DA_CONTROLLARE, bo: States.VALIDATO_BO },
    ownerId: T.v1.id,
    assegnatario: T.v1.name,
    inChargeDelivery: T.del.id,
    deliverySentToVRC: false,
